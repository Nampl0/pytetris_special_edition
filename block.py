# Declaration of basic tetris block class.
...
class Block(object):
    ...
    def rotate(self):
        ...
        # The block is rotated if the rotation is enabled
        if self.rotate_en:
    ...
    def backup(self):
        ...
        # Make the deep copy of the shape list. Also, remember the current configuration.
